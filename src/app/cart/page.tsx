        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
              ...
              {cart.map((item) => (
                ...
                >
                  <div className="w-24 h-32 bg-[#EFEEEC] shrink-0">
                    <img src="/skeleton.webp" className="w-full h-full object-cover grayscale" />
                  </div>
          ...
          <section className="lg:col-span-5 space-y-8">
            ...
            <div className="bg-[#fdf0d5] p-8 border border-black/5 space-y-6 rounded-xl ">
              ...
              <div className="p-4 bg-[#003049] text-white /50 border border-black/5">
              ...
              <button className="w-full py-3 border border-black text-[10px] uppercase tracking-widest font-bold hover:bg-black hover:text-white transition-all hover:cursor-pointer ">
                Change Address
              </button>
            </div>
            ...
            <div className="bg-[#003049] p-8 border border-black/5 space-y-4 rounded-md">
              ...
              <div className="pt-4 border-t border-black/5 flex justify-between items-end">
                <span className="text-sm uppercase tracking-widest text-zinc-100  font-bold">Total Acquisition</span>
                <span className="text-2xl text-zinc-100 font-mono">₹{(subtotal + 500).toLocaleString()}</span>
              </div>
